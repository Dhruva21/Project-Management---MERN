            ...
            <div className="modal-body">
                <form onSubmit={onSubmit}>
                    ...
                    <div className='mb-3'>
                        ...
                        <input type="email" className='form-control' id="email" value={email} onChange={addEmail}/>
                    </div>
                    <div className='mb-3'>
                        <label className='form-label'>Phone:</label>
                        <input type="text" className='form-control' id="phone" value={phone} onChange={addPhone}/>
                    </div>
